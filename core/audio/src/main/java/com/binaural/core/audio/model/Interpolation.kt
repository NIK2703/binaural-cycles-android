...
object Interpolation {
     ...
     */
    fun linear(y1: Double, y2: Double, t: Double): Double {
        return y1 + t * (y2 - y1)
    }
     ...
     */
    fun cardinal(p0: Double, p1: Double, p2: Double, p3: Double, t: Double, tension: Double = 0.0): Double {
        val t2 = t * t
        val t3 = t2 * t
     ...
     * - Проходит через все контрольные точки
     */
    fun monotone(p0: Double, p1: Double, p2: Double, p3: Double, t: Double): Double {
     ...
     */
    private fun computeMonotoneSlope(d1: Double, d2: Double): Double {
