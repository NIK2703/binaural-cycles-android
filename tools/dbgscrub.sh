...
v1() {
    ...
    expect_log "хэндофф состоялся" "beginCrossfade: SWAP"
...
v2() {
    ...
    expect_log "хэндофф настроек состоялся" "beginCrossfade: SWAP"
...
v3() {
    ...
    expect_log "менеджер снял сдвиг" "scrubReset \(прежний сдвиг=[1-9][0-9]* с"
